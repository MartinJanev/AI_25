...
def f(percent, data):
    return int(percent / 100 * len(data))
...
if __name__ == '__main__':
    ...
    train_set = c0[:f(percent, c0)] + c1[:f(percent, c1)]
    test_set = c0[f(percent, c0):] + c1[f(percent, c1):]
    ...
    maxClf = accs.index(max(accs))

    print(f'Najgolema tocnost ima klasifikatorot {names[maxClf]}')
    ...
    for row_x, class_ in zip(test_X, test_y):
        ...
        for i, model in enumerate(models):
            ...
            if prediction == 0:
                votes_0 += 2 if i == maxClf else 1
            else:
                votes_1 += 2 if i == maxClf else 1
